    ...
    public class AuthDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            var admin = new IdentityUser()
            {
                ...
                NormalizedEmail = "abhishek@gmail.com".ToUpper(),
                NormalizedUserName = "abhishek@gmail.com".ToUpper()
            };

            admin.PasswordHash = new PasswordHasher<IdentityUser>().HashPassword(admin, "abhy@123");
